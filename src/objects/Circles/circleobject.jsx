...
import { PROFILE_URL } from '../../common/Routes/constant.jsx';
            ...
            {object.map((item) => (
                <div className='background'>
                    ...
                    {item.objectTypeList.map((item1) => (
                        <>
                            <div class="typename">{item1.objectTypeName}
                            <span className='star1'><a href=''> 
                            <img
                        src={`${PROFILE_URL}/Icon-awesome-stroke-star.png`}alt=""/>
